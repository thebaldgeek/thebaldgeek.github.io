...
ACARS is a bit tricky to do, but we are working on it and of course dumphfdl already provides a VRS output, so thats very easy to get plotting and does not require any Node-RED at all.
